...
<html lang="{{ app()->getLocale() }}">
  ...
  <body id="page-top">
    ...
    <header class="masthead" style="background-image: url('img/fondo-03.jpg');width: 100%;background-size: 100% 100%;">
    ...
    <section class="contact " id="contact" style="background-image: url('img/fondo-04.jpg');background-size: auto auto;width: 100%; color: white;">
      <div class="container">
    ...
    <!-- Receta médica -->
    <section class="contact " id="receta" style="background-image: url('img/fondo-04.jpg');height: 100%; color: white;">
      <div class="container">
