...
@section('js')
  <script>
    ...
    function timbrado(){
      var conceptos = [{'claveProdServ' : '01010101', 'cantidad' : 1, 'claveUnidad' : 'H87', 'tipoUnidad' : 'Pieza', 'descripcion' : 'Consulta en el área de '+document.getElementById("especialidad").value, 'valorUnitario' : montoM, 'importe' : montoM}];
